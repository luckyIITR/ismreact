                        ...
                        <div className="table-wrap">
                            <table className="table" style={{textAlign: "center", justifyContent: "center"}} id='#table-scroll'>
                                ...
                                <tr>
                                    ...
                                    <td rowSpan="2"><Link to="Chetan Gowdigere" smooth={true} duration={1000} offset={-150} style={{cursor : "pointer", color :"#1a76bb"}}>Chetan Gowdigere </Link></td>
                                ...
                                <tr>
                                    ...
                                    <td rowSpan="2"><Link to="Chair: Suvrat Raju" smooth={true} duration={1000} offset={-150} style={{cursor : "pointer"}}>Discussion session *(Chair: Suvrat Raju)</Link></td>
